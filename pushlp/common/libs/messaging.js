    ...
    default:
        ...
        var h = function() {
            ...
            return e.prototype.create = function(e, t) {
                ...
                i = this.service + "/" + e;
                n = void 0 === r ? "Error": r.replace(this.pattern,
                function(e, n) {
                    var r = t[n];
            ...
            t.prototype.compress_ = function(e, t) {
                ...
                t += 4;
                else for (r = 0; r < 16; r++) n[r] = e[t] << 24 | e[t + 1] << 16 | e[t + 2] << 8 | e[t + 3],
                t += 4;
                for (r = 16; r < 80; r++) {
            ...
            t.prototype.update = function(e, t) {
                if (null != e) {
                    void 0 === t && (t = e.length);
                    for (var n = t - this.blockSize,
                    r = 0,
                    i = this.buf_,
                    o = this.inbuf_; r < t;) {
                        if (0 == o) for (; r <= n;) this.compress_(e, r),
                        r += this.blockSize;
                        if ("string" == typeof e) {
                            for (; r < t;) if (i[o] = e.charCodeAt(r), ++r, ++o == this.blockSize) {
                                this.compress_(i),
                                o = 0;
                                break
                            }
                        } else for (; r < t;) if (i[o] = e[r], ++r, ++o == this.blockSize) {
                            this.compress_(i),
                            o = 0;
                            break
                        }
            ...
            t.prototype.digest = function() {
                ...
                for (var n = this.blockSize - 1; n >= 56; n--) this.buf_[n] = 255 & t,
                t /= 256;
                this.compress_(this.buf_);
                var r = 0;
                for (n = 0; n < 5; n++) for (var i = 24; i >= 0; i -= 8) e[r] = this.chain_[n] >> i & 255,
                ++r;
                return e
            }
        })(function() {
                ...
                function() {
                    ...
                    function(s) {
                        ...
                        case 0:
                            r = w(t.getKey("p256dh")),
                            i = w(t.getKey("auth")),
                            o = "authorized_entity=" + e + "&endpoint=" + t.endpoint + "&encryption_key=" + r + "&encryption_auth=" + i,
                            y(n.buffer, T.buffer) || (a = w(n), o += "&application_pub_key=" + a),
                        ...
                        case 4:
                            throw s.sent(),
                            g.create(b.TOKEN_SUBSCRIBE_FAILED);
                        case 5:
                            if (h.error) throw f = h.error.message,
                            g.create(b.TOKEN_SUBSCRIBE_FAILED, {
                                message: f
                            });
                ...
                function() {
                    ...
                    function(s) {
                        ...
                        case 0:
                            o = w(r.getKey("p256dh")),
                            a = w(r.getKey("auth")),
                            c = "push_set=" + n + "&token=" + t + "&authorized_entity=" + e + "&endpoint=" + r.endpoint + "&encryption_key=" + o + "&encryption_auth=" + a,
                            y(i.buffer, T.buffer) || (u = w(i), c += "&application_pub_key=" + u),
                        ...
                        case 4:
                            throw s.sent(),
                            g.create(b.TOKEN_UPDATE_FAILED);
                        case 5:
                            if (d.error) throw p = d.error.message,
                            g.create(b.TOKEN_UPDATE_FAILED, {
                                message: p
                            });
                ...
                function() {
                    ...
                    function(s) {
                        ...
                        case 2:
                            return [4, s.sent().json()];
                        case 3:
                            if ((a = s.sent()).error) throw c = a.error.message,
                            g.create(b.TOKEN_UNSUBSCRIBE_FAILED, {
                                message: c
                            });
                            return [3, 5];
                        case 4:
                ...
                case 2:
                    ...
                    o.onsuccess = function() {
                        ...
                        if (e) {
                            ...
                            "string" == typeof t.vapidKey && (n.vapidKey = D(t.vapidKey)),
                            "string" == typeof t.auth && (n.auth = D(t.auth).buffer),
                            "string" == typeof t.auth && (n.p256dh = D(t.p256dh).buffer),
                            e.update(n),
                            e.
                            continue ()
                        }
        ...
        var U = function(e) {
                ...
                function() {
                    ...
                    function(s) {
                        ...
                        case 2:
                            ...
                            o && a && o.length > a && console.warn("This browser only supports " + a + " actions.The remaining actions will not be displayed."),
            ...
            t.prototype.onSubChange_ = function(e) {
                ...
                function() {
                    ...
                    function(i) {
                        ...
                        case 2:
                            throw t = i.sent(),
                            g.create(b.UNABLE_TO_RESUBSCRIBE, {
                                message: t
                            });
                        case 3:
                ...
                function() {
                    ...
                    function(o) {
                        ...
                        case 4:
                            ...
                            o.label = 5;
                        case 5:
                            return r ? (delete t.notification, delete t.fcmOptions, i = K(E.NOTIFICATION_CLICKED, t), [2, this.attemptToMessageClient_(r, i)]) : [2]
                        }
                    })
                })
            },
            t.prototype.getNotificationData_ = function(e) {
                if (e && "object" == typeof e.notification) {
                    ...
                    e.notification);
                    return n.data = i({},
                    e.notification.data, ((t = {}).FCM_MSG = e, t)),
                    n
                }
            },
                ...
                function() {
                    ...
                    function(o) {
                        ...
                        case 0:
                            ...
                            [4, L()];
                        case 1:
                            for (n = o.sent(), r = null, i = 0; i < n.length; i++) if (new URL(n[i].url, self.location.href).href === t) {
                                r = n[i];
                                break
                            }
                            return [2, r]
        ...
        var M = function(e) {
            ...
            t.prototype.waitForRegistrationToActivate_ = function(e) {
                ...
                return new Promise(function(n, r) {
                    if (t) if ("activated" !== t.state) if ("redundant" !== t.state) {
                        var i = function() {
            ...
            t.prototype.getSWRegistration_ = function() {
                var e = this;
                return this.registrationToUse ? this.waitForRegistrationToActivate_(this.registrationToUse) : (this.registrationToUse = null, navigator.serviceWorker.register("sw.js").
                catch(function(e) {
        ...
        t.INTERNAL.registerService("messaging",
        function(e) {
